...
class AmountFragment : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        btnAddToCart.setOnClickListener {
            ...
            var ptoUrl = "http://192.168.43.249/store/insert_temporary_order.php?email=${Person.email}&product_id=${Person.addToCartProductID}&amount=${edtEnterAmount.text.toString()}"
